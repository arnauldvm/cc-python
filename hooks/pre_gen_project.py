...
rules = {
    ...
    'dist_name': r'(?i)^([A-Z0-9]|[A-Z0-9][A-Z0-9._-]*[A-Z0-9])$',  # PEP-423; PEP508 ^(?i)([A-Z0-9]|[A-Z0-9][A-Z0-9._-]*[A-Z0-9])$
    'package_name': r'^[a-z][a-z0-9]*$',  # PEP8 (lowercase, no '_') & https://docs.python.org/3/reference/lexical_analysis.html#identifiers
